...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('HOST', 'mysql'),  # You can use a different host if your MySQL server is on a remote machine.
        'PORT': os.environ.get('PORT', '3306'),  # Leave this empty to use the default MySQL port (3306).
    }
}
